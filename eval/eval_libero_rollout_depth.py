...
This mirrors ZaMin/LAPA/eval/eval_libero_rollout.py, but each /act request also
sends a depth_id. For smoke overfit tests with offline depth features, pass a
DEPTH_VIDEO_ID matching the demonstration video used for training, e.g.
libero_90_TASK_NAME_demo_0, and timestep t becomes DEPTH_VIDEO_ID_00000t.
"""
