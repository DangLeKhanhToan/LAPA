...
CHECKPOINT="${CHECKPOINT:-params::$PROJECT_DIR/lapa_checkpoints/params_v6_10}"

# Where results.json + per-episode videos go.
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_DIR/outputs/eval_libero_10_$(date +%Y%m%d_%H%M%S)}"
...
ACTION_SCALE_FILE="${ACTION_SCALE_FILE:-$PROJECT_DIR/datasets/lapa_libero/action_bins_libero_10.csv}"
