...
class FlaxVideoLLaMAPreTrainedModel(FlaxPreTrainedModel):
    ...
    def init_cache(self, batch_size, max_length):
        ...
        init_variables = self.module.init(
            jax.random.PRNGKey(0), input_ids, vision_masks, delta_masks, action_masks, attention_mask, segment_ids, position_ids, return_dict=False, init_cache=True
        )
    ...
    def init_weights(self, rng, input_shape, params=None):
        ...
        random_params = self.module.init(rngs, input_ids, vision_masks, delta_masks, action_masks, attention_mask, segment_ids, position_ids, return_dict=False)["params"]
